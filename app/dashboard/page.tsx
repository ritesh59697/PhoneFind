...
export default function DashboardPage() {
  ...
  if (loading) {
    return (
      <div className={`min-h-screen flex items-center justify-center p-6 ${darkMode ? "bg-[#0B0F17] text-neutral-300" : "bg-[#F4F4EE] text-neutral-900"}`}>
      ...
      <div className="max-w-4xl mx-auto p-6 md:p-10">
        ...
        <header className={`flex items-center justify-between pb-6 mb-8 border-b-[2.5px] ${darkMode ? "border-neutral-800" : "border-neutral-900"}`}>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={logout}
              className={`inline-flex items-center gap-2 text-xs font-mono font-bold uppercase tracking-wider px-4 py-3 rounded-xl border-[2.5px] transition-all active:translate-x-[2px] active:translate-y-[2px] ${
                darkMode
                  ? "bg-[#111622] hover:bg-[#1A2130] border-neutral-600 text-neutral-200 shadow-[3px_3px_0px_0px_rgba(255,255,255,0.08)]"
                  : "bg-white hover:bg-stone-200 border-black text-neutral-900 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
              }`}
            >
        ...
        {devices.length === 0 && (
          <div className={`p-10 text-center border-[2.5px] rounded-2xl transition-all ${
            darkMode
              ? "bg-[#111622] border-neutral-700 shadow-[5px_5px_0px_0px_rgba(255,255,255,0.08)]"
              : "bg-white border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)]"
          }`}>
            <div className="w-14 h-14 rounded-2xl border-2 border-emerald-500 bg-emerald-500/10 flex items-center justify-center mx-auto mb-4 text-emerald-500">
        ...
        <div className="space-y-6">
          {devices.map((device) => (
            <div key={device.id} className={`border-[2.5px] rounded-2xl p-5 md:p-6 transition-all ${
              darkMode
                ? "bg-[#111622] border-neutral-600 shadow-[5px_5px_0px_0px_rgba(255,255,255,0.08)]"
                : "bg-white border-black shadow-[5px_5px_0px_0px_rgba(0,0,0,1)]"
            }`}>
              {/* Card Header Section */}
              ...
              {device.lastLocation ? (
                ...
                <div className={`my-4 p-4 border-2 rounded-xl text-xs font-mono font-bold text-neutral-400 flex items-center gap-2.5 ${
                  darkMode ? "bg-[#090D12] border-neutral-800" : "bg-stone-100 border-black"
                }`}>
              ...
              <div className={`grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5 pt-4 border-t-2 ${darkMode ? "border-neutral-800" : "border-neutral-200"}`}>
                ...
                <button
                  ...
                  className={`inline-flex items-center justify-center gap-2 text-xs font-mono font-bold uppercase tracking-wider px-3.5 py-3 rounded-xl border-2 transition-all active:translate-x-[2px] active:translate-y-[2px] active:shadow-none disabled:opacity-50 ${
                    darkMode
                      ? "bg-neutral-800 hover:bg-neutral-700 text-white border-neutral-600 shadow-[3px_3px_0px_0px_rgba(255,255,255,0.08)]"
                      : "bg-white hover:bg-stone-100 text-neutral-900 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
                  }`}
                >
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 text-xs font-mono font-bold uppercase tracking-wider px-3.5 py-3 rounded-xl border-2 border-red-500 bg-red-500/10 hover:bg-red-500/20 text-red-500 shadow-[3px_3px_0px_0px_rgba(239,68,68,0.3)] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all disabled:opacity-50"
                >
